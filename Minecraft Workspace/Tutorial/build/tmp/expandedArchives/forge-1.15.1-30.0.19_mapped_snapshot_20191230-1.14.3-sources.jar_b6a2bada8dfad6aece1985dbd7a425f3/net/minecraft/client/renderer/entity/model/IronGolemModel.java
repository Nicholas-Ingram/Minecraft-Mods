...
public class IronGolemModel<T extends IronGolemEntity> extends SegmentedModel<T> {
   ...
   public IronGolemModel() {
      ...
      this.ironGolemHead.setTextureOffset(0, 0).func_228301_a_(-4.0F, -12.0F, -5.5F, 8.0F, 10.0F, 8.0F, 0.0F);
      this.ironGolemHead.setTextureOffset(24, 0).func_228301_a_(-1.0F, -5.0F, -7.5F, 2.0F, 4.0F, 2.0F, 0.0F);
      this.ironGolemBody = (new ModelRenderer(this)).setTextureSize(128, 128);
      this.ironGolemBody.setRotationPoint(0.0F, -7.0F, 0.0F);
      this.ironGolemBody.setTextureOffset(0, 40).func_228301_a_(-9.0F, -2.0F, -6.0F, 18.0F, 12.0F, 11.0F, 0.0F);
      this.ironGolemBody.setTextureOffset(0, 70).func_228301_a_(-4.5F, 10.0F, -3.0F, 9.0F, 5.0F, 6.0F, 0.5F);
      this.ironGolemRightArm = (new ModelRenderer(this)).setTextureSize(128, 128);
      this.ironGolemRightArm.setRotationPoint(0.0F, -7.0F, 0.0F);
      this.ironGolemRightArm.setTextureOffset(60, 21).func_228301_a_(-13.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F, 0.0F);
      this.ironGolemLeftArm = (new ModelRenderer(this)).setTextureSize(128, 128);
      this.ironGolemLeftArm.setRotationPoint(0.0F, -7.0F, 0.0F);
      this.ironGolemLeftArm.setTextureOffset(60, 58).func_228301_a_(9.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F, 0.0F);
