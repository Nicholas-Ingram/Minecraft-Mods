...
public class TurtleModel<T extends TurtleEntity> extends QuadrupedModel<T> {
   ...
   public TurtleModel(float p_i48834_1_) {
      ...
      this.body.setTextureOffset(7, 37).func_228301_a_(-9.5F, 3.0F, -10.0F, 19.0F, 20.0F, 6.0F, 0.0F);
      this.body.setTextureOffset(31, 1).func_228301_a_(-5.5F, 3.0F, -13.0F, 11.0F, 18.0F, 3.0F, 0.0F);
      this.body.setRotationPoint(0.0F, 11.0F, -10.0F);
      this.pregnant = new ModelRenderer(this);
      this.pregnant.setTextureOffset(70, 33).func_228301_a_(-4.5F, 3.0F, -14.0F, 9.0F, 18.0F, 1.0F, 0.0F);
